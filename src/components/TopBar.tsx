  ...
  return (
    <header className="sticky top-0 z-40 bg-white border-b border-[#eaeaea] px-6 md:px-8 h-[56px] flex items-center justify-between">
      ...
      <div className="flex items-center gap-2">
        {/* Help */}
        <button className="w-9 h-9 rounded-full flex items-center justify-center text-[#999] hover:bg-[#f5f5f5] hover:text-[#666] transition-colors">
        ...
        {/* Notifications */}
        <button className="relative w-9 h-9 rounded-full flex items-center justify-center text-[#999] hover:bg-[#f5f5f5] hover:text-[#666] transition-colors">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
