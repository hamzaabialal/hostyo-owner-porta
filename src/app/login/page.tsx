...
function LoginForm() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f5] flex flex-col">
      {/* Logo top-left — same position as dashboard sidebar */}
      ...
      <div className="flex-1 flex items-center justify-center p-4 -mt-10">
        <div className="w-full max-w-[420px]">
          <div className="bg-white rounded-[28px] p-9 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.15),0_8px_20px_-8px_rgba(128,2,14,0.08)]">
            {step === "credentials" ? (
              <>
                ...
                <p className="text-[13px] text-[#999] text-center mb-7">Sign in to your owner portal</p>

                {loginError && (
                  <div className="mb-5 p-3 bg-[#F6EDED] border border-[#E8D8D8] rounded-xl text-[12px] text-[#7A5252] font-medium text-center">{loginError}</div>
                )}
              ...
              <>
                ...
                <div className="text-center mb-6">
                  ...
                  <h1 className="text-[22px] font-bold text-[#111] mb-1">Verify your identity</h1>
          ...
          <p className="text-[13px] text-[#999] text-center mt-6">
            ...
            <a href="/signup" className="text-[#111] font-semibold hover:underline">Sign up</a>
          </p>
        </div>
      </div>
    </div>
