    ...
    <AppShell title="Reservations">
      ...
      <div className="flex items-center gap-1.5 mb-4 md:hidden flex-wrap">
        ...
        <div className="flex items-center gap-1 ml-auto">
          <button onClick={() => setMobileView("list")} className={`w-8 h-8 rounded-lg flex items-center justify-center transition-all ${mobileView === "list" ? "text-[#80020E] border border-[#80020E] bg-[#80020E]/5" : "text-[#888] border border-transparent hover:text-[#555] hover:bg-[#f5f5f5]"}`}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><line x1="3" y1="6" x2="3.01" y2="6"/><line x1="3" y1="12" x2="3.01" y2="12"/><line x1="3" y1="18" x2="3.01" y2="18"/></svg>
          </button>
          <button onClick={() => setMobileView("calendar")} className={`w-8 h-8 rounded-lg flex items-center justify-center transition-all ${mobileView === "calendar" ? "text-[#80020E] border border-[#80020E] bg-[#80020E]/5" : "text-[#888] border border-transparent hover:text-[#555] hover:bg-[#f5f5f5]"}`}>
